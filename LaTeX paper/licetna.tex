...
Codul aferent întregii entități VHDL a program counter-ului se regăsește în Figura \ref{Figura:38}.
 ...
 \caption{Bistabilul sincron ca entitate VHDL}
 \label{Figura:38}
 \includegraphics[width=0.5\textwidth]{programcountercode.png}
 \end{figure}
...
\item Instrucțiunile din familia B, acestea asigurând încărcarea valorilor îm registrul \textit{rs1} dintr-o adresă din memoria de date calculată ca suma unui offset furnizat ca valoare imediată și valoarea din registrul \textit{rs2}.
\end{itemize}
